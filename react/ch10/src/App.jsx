...
/**
 * - ch8(할 일 관리 앱)의 소스를 사용
 *
 * - useReducer hook 활용
 *    목적 : root app 에는 자식 컴포넌트에서 사용될 기능 ( 함수 )을
 *           직접 구현해서 자식에게 전달하고 있음
 *
 *           따라서, 향후에 자식 컴포넌트에서 기능이 대폭 늘어날 수 있다고 가정하면, root app 에서 관리해야 함
 *
 ...
 *
 *           따라서, 관계의 깊이가 깊어지면 질수록 유지보수가 힘들어짐
 *           버그 발생 가능성이 높아짐
 *
 *           => 만약에 App 에서 TodoItem 으로 삭제함수를 direct 로 전달할 수 있으면 어떨까?
 *
 */
...
// createContext 가 계속 생성됨으로, App() 밖에 만들어요.
